...
<head>
	...
	<title>CKAMS | Admin Manage Pages</title>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
														...
														<option value="manage-pages.php?type=hadis">Hadis</option>
														<option value="manage-pages.php?type=addmission">addmission</option> 
