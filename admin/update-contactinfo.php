...
<head>
	...
	<title>CKAMS | Admin Update Contact info</title>
...
{				?>	
				...
				<div class="form-group">
												...
												<div class="col-sm-8">
													<textarea class="form-control" name="address" id="address" style="font-family: 'SolaimanLipi', Arial, sans-serif" required><?php echo htmlentities($result->Address);?></textarea>
												</div>
											</div>
											<div class="form-group">
